...
export default function About() {
  ...
  return (
    ...
    >
      <h2 ref={titleRef} className="z-10 text-[15vw] md:text-[12vw] leading-none font-black font-oswald text-white md:whitespace-nowrap text-center select-none drop-shadow-[0_0_15px_rgba(255,255,255,0.1)] will-change-transform pointer-events-none">
        WHO WE <br className="md:hidden" /> ARE
      </h2>
      ...
      <div ref={gridRef} className="relative z-20 container mx-auto px-4 md:px-6 pt-24 md:pt-[25vh] pb-8 md:pb-0 h-full flex flex-col justify-start">
        <div className="grid grid-cols-1 md:grid-cols-12 auto-rows-auto md:auto-rows-[240px] gap-6 w-full max-w-7xl mx-auto">
          ...
          <div className="about-card-anim order-1 md:order-none md:col-span-8 p-6 md:p-8 bg-gradient-to-br from-lime-500/25 via-zinc-900/90 to-zinc-900/90 backdrop-blur-xl border border-white/10 rounded-lg relative overflow-hidden group hover:border-lime-400/30 transition-colors shadow-2xl flex flex-col justify-center">
          ...
          <div className="about-card-anim order-2 md:order-none md:col-span-4 w-full h-[240px] md:h-full">
            <PerformanceCube />
          </div>

          <div className="about-card-anim order-4 md:order-none md:col-span-4 w-full h-[240px] md:h-full">
            <SupportCube />
          </div>

          {/* --- VISION CARD (Bottom Long) --- */}
          {/* UPDATED: Applied 'group hover:border-lime-400/30' EXACTLY as First Container */}
          <div className="about-card-anim order-3 md:order-none md:col-span-8 p-6 md:p-8 bg-gradient-to-tl from-lime-500/25 via-zinc-900/90 to-zinc-900/90 backdrop-blur-xl border border-lime-400/20 rounded-lg flex flex-col md:flex-row md:items-center justify-between shadow-2xl group hover:border-lime-400/30 transition-colors gap-4 md:gap-0">
