  ...
  return (
    ...
    >
      <div className="relative transition-transform duration-500 ease-[cubic-bezier(0.76,0,0.24,1)] group-hover:-translate-y-full">
        <span className="block group-hover:text-white transition-colors duration-500">
          {children}
        </span>
    ...
    >
      ...
      <div className="container relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 min-h-[350px]">
          ...
          <div className="md:col-span-4 py-16 md:pr-12 flex flex-col justify-between relative">
          ...
          <div className="md:col-span-2 py-16 md:px-8 relative">
            <h4 className="footer-anim text-white font-oswald uppercase text-sm mb-8 tracking-widest flex items-center gap-2">
          ...
          <div className="md:col-span-3 py-16 md:px-8 relative">
            <h4 className="footer-anim text-white font-oswald uppercase text-sm mb-8 tracking-widest flex items-center gap-2">
          ...
          <div className="md:col-span-3 py-16 md:pl-8 flex flex-col justify-between">
             
             {/* Location Data */}
             <div className="footer-anim">
                <h4 className="text-white font-oswald uppercase text-sm mb-8 tracking-widest flex items-center gap-2">
