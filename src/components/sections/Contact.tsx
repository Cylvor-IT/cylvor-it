...
export default function Contact() {
  ...
  return (
    <section ref={container} id="contact" className="relative min-h-screen py-24 md:py-32 px-6 bg-black overflow-hidden flex flex-col items-center justify-center">
      ...
      <div className="container relative z-10 max-w-4xl text-center">
        ...
        >
          ...
          <div className="text-center relative z-10">
            <Button 
              type="submit" 
              className="group relative overflow-hidden px-12 py-5 bg-white text-black hover:bg-red-600 hover:text-white font-black uppercase tracking-widest rounded-sm transition-all duration-500 w-full md:w-auto font-oswald text-lg shadow-xl"
            >
        ...
        <div className="social-container flex flex-wrap justify-center gap-8 md:gap-12 text-zinc-500 font-mono text-[10px] tracking-widest relative z-10">
            <a href="#" className="social-icon flex items-center space-x-2 hover:text-white transition-colors group">
              <Facebook size={18} className="group-hover:text-red-600 transition-colors" />
              <span>FACEBOOK</span>
            </a>
            <a href="#" className="social-icon flex items-center space-x-2 hover:text-white transition-colors group">
              <Instagram size={18} className="group-hover:text-red-600 transition-colors" />
              <span>INSTAGRAM</span>
            </a>
            <a href="#" className="social-icon flex items-center space-x-2 hover:text-white transition-colors group">
              <Linkedin size={18} className="group-hover:text-red-600 transition-colors" />
              <span>LINKEDIN</span>
            </a>
            <a href="mailto:hello@cylvor.it" className="social-icon flex items-center space-x-2 hover:text-white transition-colors group">
              <Mail size={18} className="group-hover:text-red-600 transition-colors" />
              <span>GMAIL</span>
            </a>
        </div>
      </div>
