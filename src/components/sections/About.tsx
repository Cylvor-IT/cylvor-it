...
export default function About() {
  ...
  return (
    ...
    <section id="about" ref={container} className="py-24 md:py-32 px-6 bg-transparent relative">
      <div className="container mx-auto grid md:grid-cols-2 gap-16 items-center">
        <div className="about-text">
          ...
          <p className="text-zinc-400 text-lg leading-relaxed font-sans">
            Cylvor IT goes beyond code. We are a strategic technology partner dedicated to bridging the gap between complex engineering and intuitive design.
          </p>
        </div>
